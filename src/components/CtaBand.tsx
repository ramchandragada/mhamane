...
export function CtaBand() {
  return (
    <section className="relative overflow-hidden bg-copper">
      <div className="container-site section-pad relative">
        <Reveal>
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl">
              <p className="text-[0.7rem] font-semibold uppercase tracking-[0.22em] text-stone-warm/80">
                Ready when you are
              </p>
              <h2 className="display mt-4 text-4xl text-stone-warm sm:text-5xl lg:text-6xl">
                Let&apos;s discuss your next build.
              </h2>
              <p className="mt-5 max-w-lg text-lg text-stone-warm/85">
